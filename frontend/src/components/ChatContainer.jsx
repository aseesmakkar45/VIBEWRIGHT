          ...
          <div className="flex flex-col items-center text-center animate-fade-in-up">
            ...
            <div className="flex items-center gap-2 bg-panel/50 backdrop-blur-md border border-bd-subtle rounded-xl p-3 mb-12 max-w-lg shadow-sm">
              ...
              <p className="text-sm font-sans text-tx-secondary text-left leading-relaxed">
                VibeWright Engine can synthesize a digital clone of <span className="font-semibold text-tx-primary">any person</span> using their historical timeline data. For this demonstration, you are interacting with the persona of <span className="font-semibold text-accent">Elon Musk</span>.
              </p>
            </div>
